...
export const CHORDS: Record<string, ChordGroup> = {
	...
	'Eleventh Chords': {
		...
		add11: { symbol: 'add11', display: 'Major Add 11', intervals: [2, 1.5, 5] },
		'minor-add11': { symbol: 'madd11', display: 'Minor Add 11', intervals: [1.5, 2, 5] },
	...
	'Thirteenth Chords': {
		...
		add13: { symbol: 'add13', display: 'Major Add 13', intervals: [2, 1.5, 1] },
		'minor-add13': { symbol: 'madd13', display: 'Minor Add 13', intervals: [1.5, 2, 1] },
		'major-minor-13': {
			symbol: 'mM13',
